...
export function CTASection({
  ...
  return (
    <section
      className={cn(
        "relative overflow-hidden pt-0 md:pt-0 bg-gradient-to-br from-primary via-pink-400 via-60% to-yellow-400 animate-gradient-x",
        className
      )}
    >
      <div className="relative mx-auto flex max-w-container flex-col items-center gap-6 px-8 py-12 text-center sm:gap-8 md:py-24">
        ...
        {badge && (
          <Badge
            variant="outline"
            className="opacity-0 animate-fade-in-up delay-100 text-white border-white"
          >
        ...
        {/* Description */}
        {description && (
          <p className="text-white opacity-0 animate-fade-in-up delay-300">
            {description}
          </p>
        )}
        {/* Action Button */}
